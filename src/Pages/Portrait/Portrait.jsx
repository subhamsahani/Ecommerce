...
const Portrait = () => {
  ...
  return (
    <div className="text-center p-10">
      {/* <h1 className="font-bold text-4xl mb-4">A</h1>
      <h1 className="text-3xl">Tailwind CSS</h1> */}

      <section
        id="Projects"
        className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-5 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5"
      >
